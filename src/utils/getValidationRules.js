...
const getConditions = ({conditions, answers, questionType}) => conditions.map(
  condition => {
    ...
    return operations[condition.type](
...
const getValidationRules = ({validation, answers, questionType}) => validation.rules.map(rule => {
